package com.yannickmyxe.neochests.block;
...
public class ModBlocks {
    public static final DeferredRegister.Blocks  BLOCKS = DeferredRegister.createBlocks(NeoChests.MOD_ID);
    ...
    public static final DeferredBlock<Block> BISMUTH_ORE_BLOCK = registerBlock("bismuth_ore",
